...
// Macro for signaling unimplemented functions with file and line
...
// Heap capacity in bytes and words
...
// External declarations for heap and stack base
...
// Maximum number of chunks in a list
...
// Structure representing a list of memory chunks
typedef struct {
    size_t count;
    Chunk chunks[CHUNK_LIST_CAP];
} Chunk_List;

// External declarations for allocated, freed, and temporary chunks
extern Chunk_List alloced_chunks;
extern Chunk_List freed_chunks;
extern Chunk_List tmp_chunks;

// Function declarations for managing lists of memory chunks
